...
class AppStore extends Component {
  state = {activeTab: tabsList[0].tabId, inputVal: ''}
  ...
  render() {
    const {activeTab, inputVal} = this.state
    const filteredAppItem = this.getFilteredData()

    const filteredInput = appsList.filter(eachItem =>
